...
export const WorkWithMeModal: React.FC<WorkWithMeModalProps> = ({ isOpen, onClose }) => {
  ...
  const modalContent = (
    ...
    >
      ...
      {/* Dialogue Box (Centered on Desktop & Mobile) */}
      <div className="relative z-10 w-full max-w-lg rounded-3xl border border-white/15 bg-[#12071B] p-6 sm:p-8 shadow-[0_25px_80px_rgba(255,155,210,0.4)] overflow-hidden text-left transform-gpu animate-modalPop">
